            ...
            <section className="hero">
                <div className="container">
                    ...
                    <div className="hero-cta">
                        ...
                        <Link to="/matematika/dbh2/ekuazioak/laboratorio" className="btn btn-primary">{t('nav.lab')}</Link>
                        <Link to="/matematika/dbh2/ekuazioak/retos" className="btn btn-secondary">{t('nav.challenges')}</Link>
                        <Link to="/matematika/dbh2/ekuazioak/ejercicios" className="btn btn-secondary">{pickText(lang, { eu: 'Ariketak', es: 'Ejercicios', ar: 'التمارين' })}</Link>
